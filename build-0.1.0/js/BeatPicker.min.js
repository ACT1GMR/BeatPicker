...
ar:function(){var a=this;this.view.alwaysVisible||(a.k.css("display","none"),$("html,body").on(this.view.hideOn,function(b){!a.v&&a.hide()}),this.k.on("click",function(a){a.stopPropagation()}));var b=this.dateInputNode;this.selectionRule.range&&(b=this.dateInputNode.add(this.b));b.on(this.view.showOn,function(b){b.stopPropagation();if(a.v||a.selectionRule.range){var d=$.grep(window.beatPickerList,function(b,c){return b!==a&&!b.view.alwaysVisible});a.forEach(d,function(a,b){!b.isHide()&&b.k.hide()},
